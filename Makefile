...
colour_graph: $(ALGO)/Algorithm.o $(ALGO)/ContractAlgorithm.o $(ALGO)/ParallelContractAlgorithm.o $(GRAPH)/MatrixGraph.o ColourGraph.o
		$(CC) $(PTFLAGS) -o colour_graph $(ALGO)/Algorithm.o $(ALGO)/ContractAlgorithm.o $(ALGO)/ParallelContractAlgorithm.o $(GRAPH)/MatrixGraph.o ColourGraph.o $(TIMEFLAGS)
